...
string fullHelpMessage(void) {
  string msg =
    ...
    "EXAMPLES\n"
    "\n"
    "\twater-hist --radius=15 --bulk=25 --scale=1 b2ar.pdb b2ar.dcd | gridgauss 4 2 | grid2xplor >b2ar_water.xplor\n"
    "Internal water for a GPCR with a bulk estimate, converted to Xplor EDM:\n"
    "\n"
    "\twater-hist --bulk=25 --scale=2 --bulked=20,25:50 b2ar.pdb b2ar.dcd | gridgauss 4 2 | grid2xplor >b2ar_water.xplor\n"
    "Internal water for a GPCR with the bulk solvent layer added back, converted to Xplor EDM:\n"
    "\n"
    "\twater-hist --radius=20 --prot='resid > 10 && resid < 25' --mode=radius | gridgauss 4 2 | grid2xplor >binding.xplor\n"
    "All water within a given radius of a binding pocket, converted to Xplor EDM:\n"
    "\n"
    "\twater-hist --gridres=0.5 b2ar.pdb b2ar.dcd | gridgauss 8 4 | grid2xplor >b2ar_water.xplor\n"
