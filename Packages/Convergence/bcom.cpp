...
string fullHelpMessage() {
  ...
  string s = 
    ...
    "of increasingly long trajectory \"blocks\".  \n"
    ""
    "Output a tab separated stream:\n"
    ...
    //
    "EXAMPLES\n"
    "bcom -b 25:25:500 model.pdb traj.dcd 'name==\"CA\"'\n"
    "\tCalculate the bcom of traj.dcd using a PCA of CA atoms. \n"
    "\tThis is done for blocks in a range of 25 ns to 500 ns, with\n"
    "\t25 ns intervals.\n"
    "\n"
    "\n"
    "\n"
