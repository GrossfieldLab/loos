...
string s =
  ...
  "left singular vectors (LSVs) are normalized by 1/3n there n is the\n"
  "number of atoms used in the calculation.  The right singular vectors\n"
  "(RSVs) are normalized by 1/L where L is the length of the trajectory\n"
  "(i.e. number of frames).  The LSVs are the same as the eigenvectors\n"
  "from a traditional PCA.  The singular values are just the square\n"
  "roots of the PCA eigenvalues, and are in Angstroms.\n"
  "\n"
  //
  "EXAMPLES\n"
  "\n"
