...
string fullHelpMessage(void) {
  string msg =
    ...
    "\tramachandran can make print out a rough secondary structure assignment based on\n"
    "phi/psi angles.  Use the --assign=1 option to turn this on.  Rectangular regions\n"
    "in the plot that roughly correspond to the clasically allowed regions are used\n"
