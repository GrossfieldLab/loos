...
string fullHelpMessage() {
  string s = 
    ...
    "\n"
    "NOTES\n"
    "\tTo get a correct fractional contact value, you will need to ensure that\n"
    "anything that can make a contact is included in the target list.  Alternatively,\n"
    "use the fcontacts tool.\n"
